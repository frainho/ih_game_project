...
function main() {
  ...
  var styleBtn = document.querySelector(".style-btn");
  var playerDataInput,
    playerData,
    playerDataWrapper,
    playerDataBtn,
  ...
  styleBtn.addEventListener("click", changeColors);

  function changeColors() {
    if (!contrastOn) {
      contrastOn = true;
      style.setAttribute("href", "./css/alt_style.css");
    } else {
      contrastOn = false;
  ...
  */
  ...
  function loadNewPlayerScreen() {
    ...
    playerTip.innerText =
      "Psst... use the input to search the types of gifs you prefer!";
  ...
  */
  ...
  function createMainGameScreen() {
    ...
    statsSpeed.innerText =
      "Speed: " + playerData.speed + " (keystrokes/line of code)";
  ...
  */
  ...
  function loadTitleData() {
    ...
    info.innerText =
      " Thank you so much for playing. This game was created by Filipe Rainho for the Ironhack Game Project with help of the awesome teacher and TAs!";
  ...
  */
  ...
  function loadStatsData() {
    ...
    moneyText.innerText =
      "You made " + playerData.money + " so far. Reach 700 to win!";

    var speedText = document.createElement("p");
    speedText.innerText =
      "You need " +
      playerData.speed +
      " keystrokes in order to do a line of code. Check for upgrades to see if you can get faster!";
    ...
    if (currentProject.linesTbd === 0) {
      ...
      if (playerData.money >= 700) {
        ...
        congratsMessage.innerText =
          "Wooohoooooo! You completed the project. 200 have been added to your account";
    ...
    if (playerData.projectHistory.length > 0) {
      ...
      for (var i = 0; i < playerData.projectHistory.length; i++) {
        ...
        project.innerText =
          ...
          1 +
          ": This project was a " +
          playerData.projectHistory[i].type +
          "with the name " +
          playerData.projectHistory[i].name;
  ...
  */
  ...
  function isWinner() {
    ...
    winnerDiv.innerHTML =
      "<iframe width='400' height='225' src='https://www.youtube.com/embed/1Bix44C1EzY?autoplay=1' frameborder='0' allow='autoplay; encrypted-media' allowfullscreen></iframe><p>WIIIIIIINNNNNNNNNNNNNNNNNEEEEEEERRRRR!</p>";
